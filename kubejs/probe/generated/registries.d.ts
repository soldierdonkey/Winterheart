...
declare namespace Registry {
    ...
    class Item extends Internal.RegistryEventJS<any> {
        ...
        create(id: string, type: "sanity_source"): Internal.SanitySourceItem$Builder;
        create(id: string, type: "sanity_helmet"): Internal.SanityPassiveArmorItem$HelmetBuilder;
        create(id: string, type: "sanity_chestplate"): Internal.SanityPassiveArmorItem$ChestplateBuilder;
        create(id: string, type: "sanity_leggings"): Internal.SanityPassiveArmorItem$LeggingsBuilder;
        create(id: string, type: "sanity_boots"): Internal.SanityPassiveArmorItem$BootsBuilder;
        create(id: string, type: "tacz_gun"): Internal.CustomGunItemBuilder;
    ...
    class DynamicTemperatureModifiers extends Internal.RegistryEventJS<any> {
    }
    class ItemAttributeTemperatureModifiers extends Internal.RegistryEventJS<any> {
    }
