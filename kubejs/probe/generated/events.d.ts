...
declare const SanityEvents: {
    /**
     * @at *client*
     * 
     * @cancellable
    */
indicatorRender(handler: (event: Internal.SanityIndicatorRenderEventJS) => void):void,
    /**
     ...
     * @cancellable
    */
change(handler: (event: Internal.SanityChangeEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
itemSource(extra: Internal.Item_, handler: (event: Internal.SanityItemSourceEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
trigger(extra: SanityEventType_, handler: (event: Internal.SanityTriggerEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
equippedSource(extra: Internal.Item_, handler: (event: Internal.SanityEquippedSourceEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
    */
tick(handler: (event: Internal.SanityTickEventJS) => void):void,
};
...
beforeRenderHand(handler: (event: Internal.GunKubeJSEvents$BeforeRenderHandEventJS) => void):void,
     ...
     * @cancellable
    */
gunFireSelect(extra: string, handler: (event: Internal.GunKubeJSEvents$GunFireSelectEventJS) => void):void,
...
renderLevelBobHurt(handler: (event: Internal.GunKubeJSEvents$RenderLevelBobHurtEventJS) => void):void,
     ...
     * @cancellable
    */
entityHurtByGunPre(extra: string, handler: (event: Internal.GunKubeJSEvents$EntityHurtByGunPreEventJS) => void):void,
entityHurtByGunPre(handler: (event: Internal.GunKubeJSEvents$EntityHurtByGunPreEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
...
ammoHitBlock(handler: (event: Internal.GunKubeJSEvents$AmmoHitBlockEventJS) => void):void,
     ...
     * @cancellable
    */
renderItemInHandBobHurt(extra: string, handler: (event: Internal.GunKubeJSEvents$RenderItemInHandBobHurtEventJS) => void):void,
renderItemInHandBobHurt(handler: (event: Internal.GunKubeJSEvents$RenderItemInHandBobHurtEventJS) => void):void,
    /**
     * @at *server, client*
     * 
     * @cancellable
    */
gunMelee(extra: string, handler: (event: Internal.GunKubeJSEvents$GunMeleeEventJS) => void):void,
gunMelee(handler: (event: Internal.GunKubeJSEvents$GunMeleeEventJS) => void):void,
    /**
     * @at *server*
    */
...
gunFire(handler: (event: Internal.GunKubeJSEvents$GunFireEventJS) => void):void,
     ...
     * @at *server, client*
    */
entityHurtByGunPost(extra: string, handler: (event: Internal.GunKubeJSEvents$EntityHurtByGunPostEventJS) => void):void,
entityHurtByGunPost(handler: (event: Internal.GunKubeJSEvents$EntityHurtByGunPostEventJS) => void):void,
    /**
     * @at *server, client*
    */
...
renderLevelBobView(handler: (event: Internal.GunKubeJSEvents$RenderLevelBobViewEventJS) => void):void,
     ...
     * @cancellable
    */
gunReload(extra: string, handler: (event: Internal.GunKubeJSEvents$GunReloadEventJS) => void):void,
gunReload(handler: (event: Internal.GunKubeJSEvents$GunReloadEventJS) => void):void,
    /**
     * @at *server, client*
     * 
     * @cancellable
    */
gunShoot(extra: string, handler: (event: Internal.GunKubeJSEvents$GunShootEventJS) => void):void,
gunShoot(handler: (event: Internal.GunKubeJSEvents$GunShootEventJS) => void):void,
    /**
     * @at *client*
     * 
     * @cancellable
...
entityKillByGun(handler: (event: Internal.GunKubeJSEvents$EntityKillByGunEventJS) => void):void,
     ...
     * @cancellable
    */
gunFinishReload(extra: string, handler: (event: Internal.GunKubeJSEvents$GunFinishReloadEventJS) => void):void,
gunFinishReload(handler: (event: Internal.GunKubeJSEvents$GunFinishReloadEventJS) => void):void,
};
...
enchantmentTableTooltip(handler: (event: Internal.EnchantmentTableTooltipEventJS) => void):void,
     ...
     * @cancellable
    */
enchantmentTableEnchant(handler: (event: Internal.PlayerEnchantEventJS) => void):void,
    /**
     * @at *server*
    */
...
filterEnchantedBookTrade(handler: (event: Internal.FilterEnchantedTradeEventJS) => void):void,
     ...
     * @at *server*
    */
structureAfterPlace(handler: (event: Internal.StructureAfterPlaceEventJS) => void):void,
    /**
     * @at *server*
    */
