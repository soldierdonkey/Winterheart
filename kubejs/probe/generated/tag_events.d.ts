...
declare namespace TagEvent {
    ...
    class BankStyle extends Internal.TagEventJS {
    get(id: Special.BankStyleTag): Internal.TagWrapper
    add(tag: Special.BankStyleTag, ...id: Special.BankStyle[]): Internal.TagWrapper
    remove(tag: Special.BankStyleTag, ...id: Special.BankStyle[]): Internal.TagWrapper
    removeAll(tag: Special.BankStyleTag): Internal.TagWrapper
    removeAllTagsFrom(...id: Special.BankStyle[]): Internal.TagWrapper
    }
